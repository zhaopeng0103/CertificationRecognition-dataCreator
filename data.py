...
def getSituation():
    return totalSituation[produceRandomInt(0, len(totalSituation) - 1)]


def getRoad():
    index = produceRandomInt(0, len(location) - 1)
    first = location[index]
    second = produceRandomInt(11, 150) + "号"
    third = "-" + produceRandomInt(1, 20) + "-" + produceRandomInt(1, 10)
    return first + second + third


def produceData():
    dataValue = [getChineseName(), getSituation(), ]
    return dataValue
