...
def getArea():
    return "分摊土地面积" + str(produceRandomFloat(30, 100)) + "平方米/房屋建筑面积" + str(produceRandomFloat(50, 150)) + "平方米"
...
def produceData():
    return [getChineseName(), getSituation(), getLocation(), getNumber(), getRightType(), getRightNature(), getUsing(),
            getArea(), getTimeLimit(), getOther()]
